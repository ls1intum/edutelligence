...
import requests
from scripts import export_to_json, run_grpc_client
...
class TestOpenAIForwardingProxy(unittest.TestCase):
    def test_add_provider(self):
        ...
        response = requests.post(
            "http://0.0.0.0:8080/logosdb/add_provider", json=data, headers=headers
        )
    ...
    def test_add_model(self):
        ...
        response = requests.post(
            "http://0.0.0.0:8080/logosdb/add_model", json=data, headers=headers
        )
        from pprint import pprint
    ...
    def test_add_profile(self):
        ...
        response = requests.post(
            "http://0.0.0.0:8080/logosdb/add_profile", json=data, headers=headers
        )
        from pprint import pprint
    ...
    def test_connect_model_api(self):
        ...
        response = requests.post(
            "http://0.0.0.0:8080/logosdb/connect_model_api", json=data, headers=headers
        )
        from pprint import pprint
    ...
    def test_forward_prompt(self):
        ...
        response = requests.post(
            "http://0.0.0.0:8080/v1/chat/completions", json=data, headers=headers
        )
        from pprint import pprint
    ...
    def test_add_service(self):
        ...
        response = requests.post(
            "http://0.0.0.0:8080/logosdb/add_service", json=data, headers=headers
        )
        from pprint import pprint
    ...
    def test_log(self):
        ...
        response = requests.post(
            "http://0.0.0.0:8080/logosdb/set_log", json=data, headers=headers
        )
        from pprint import pprint
