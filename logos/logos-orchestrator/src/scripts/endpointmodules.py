...
def endpoint_add_provider(
    logos_key: str, base_url: str, provider_name: str, api_key: str, provider_type: str
):
    data = {
...
def endpoint_connect_process_provider(
    logos_key: str, profile_id: int, provider_id: int
):
    data = {
        "logos_key": f"{logos_key}",
