...
- **Screenshots are MANDATORY for every UI PR** (desktop + mobile, full page, hosted in a gist, embedded in the PR description, never committed). Follow `../SKILLS.md` exactly.
...
- The app scrolls inside an inner container, not the document — see `../SKILLS.md` for how to capture a true full-page screenshot.
