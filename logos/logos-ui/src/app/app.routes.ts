...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'batches',         title: 'Batches · Logos',          data: { roles: ['logos_admin', 'app_admin'] },   canActivate: [roleGuard, hasKeysGuard], loadComponent: () => import('./features/batches/batches').then(m => m.Batches) },
