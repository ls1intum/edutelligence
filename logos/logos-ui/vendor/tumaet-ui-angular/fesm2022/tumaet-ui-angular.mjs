...
import { inject, ElementRef, Injectable, InjectionToken, makeEnvironmentProviders, Pipe, input, booleanAttribute, output, computed, ChangeDetectionStrategy, Component, ViewContainerRef, DestroyRef, numberAttribute, viewChild, TemplateRef, signal, effect, forwardRef, afterNextRender, model, contentChild, Directive, linkedSignal, viewChildren, afterRenderEffect, Injector, untracked, contentChildren, HostAttributeToken } from '@angular/core';
...
import { faXmark, faSpinner, faCheck, faMinus, faChevronRight, faChevronLeft, faCalendar, faGlobe, faClock, faChevronUp, faChevronDown, faAnglesRight, faAnglesLeft, faAngleRight, faAngleLeft, faMagnifyingGlass, faSort, faSortDown, faSortUp, faCircleQuestion } from '@fortawesome/free-solid-svg-icons';
...
class TumUiOverlayService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiOverlayService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiOverlayService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiOverlayService, decorators: [{
            type: Injectable,
...
class TumUiTranslatePipe {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTranslatePipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe });
    static ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "22.1.6", ngImport: i0, type: TumUiTranslatePipe, isStandalone: true, name: "tumUiTranslate", pure: false });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTranslatePipe, decorators: [{
            type: Pipe,
            args: [{
                    name: 'tumUiTranslate',
                    pure: false,
...
class TumUiButtonGroupComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiButtonGroupComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.1.6", type: TumUiButtonGroupComponent, isStandalone: true, selector: "tum-ui-button-group", host: { attributes: { "role": "group" }, classAttribute: "tum-ui-button-group" }, ngImport: i0, template: '<ng-content />', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiButtonGroupComponent, decorators: [{
            type: Component,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiChartAxesComponent, decorators: [{
            type: Component,
...
class TumUiChartLegendComponent {
    ...
    toggleEntry = output();
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiChartLegendComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.1.6", type: TumUiChartLegendComponent, isStandalone: true, selector: "tum-ui-chart-legend", inputs: { items: { classPropertyName: "items", publicName: "items", isSignal: true, isRequired: false, transformFunction: null }, position: { classPropertyName: "position", publicName: "position", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { toggleEntry: "toggleEntry" }, host: { properties: { "attr.data-position": "position()" }, classAttribute: "tum-ui-chart-legend" }, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiChartLegendComponent, decorators: [{
            type: Component,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiChartTooltipComponent, decorators: [{
            type: Component,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiChartDataTableComponent, decorators: [{
            type: Component,
...
class TumUiConfirmationService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiConfirmationService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiConfirmationService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiConfirmationService, decorators: [{
            type: Injectable
        }] });
...
class TumUiTooltipContentComponent {
     ...
     */
    arrowOffsetPx = input(undefined, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "arrowOffsetPx" }] : /* istanbul ignore next */ []));
    isHorizontal = computed(() => this.placement() === 'top' || this.placement() === 'bottom', /* @ts-ignore */
    ...
    hostClasses = computed(() => `${BUBBLE_BASE} ${this.items().length ? BUBBLE_WIDTH.list : BUBBLE_WIDTH.text}`, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "hostClasses" }] : /* istanbul ignore next */ []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTooltipContentComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.1.6", type: TumUiTooltipContentComponent, isStandalone: true, selector: "tum-ui-tooltip-content", inputs: { text: { classPropertyName: "text", publicName: "text", isSignal: true, isRequired: false, transformFunction: null }, items: { classPropertyName: "items", publicName: "items", isSignal: true, isRequired: false, transformFunction: null }, id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null }, placement: { classPropertyName: "placement", publicName: "placement", isSignal: true, isRequired: false, transformFunction: null }, arrowOffsetPx: { classPropertyName: "arrowOffsetPx", publicName: "arrowOffsetPx", isSignal: true, isRequired: false, transformFunction: null } }, host: { attributes: { "role": "tooltip" }, properties: { "attr.id": "id()", "class": "hostClasses()" }, classAttribute: "tum-ui-tooltip-bubble" }, ngImport: i0, template: `
        @if (items().length) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTooltipContentComponent, decorators: [{
            type: Component,
            args: [{
    ...
    `,
        ...
        }], propDecorators: { text: [{ type: i0.Input, args: [{ isSignal: true, alias: "text", required: false }] }], items: [{ type: i0.Input, args: [{ isSignal: true, alias: "items", required: false }] }], id: [{ type: i0.Input, args: [{ isSignal: true, alias: "id", required: false }] }], placement: [{ type: i0.Input, args: [{ isSignal: true, alias: "placement", required: false }] }], arrowOffsetPx: [{ type: i0.Input, args: [{ isSignal: true, alias: "arrowOffsetPx", required: false }] }] } });
...
class TumUiTooltipDirective {
     ...
     */
    describesHost = input(true, { ...(ngDevMode ? { debugName: "describesHost" } : /* istanbul ignore next */ {}), alias: 'tumUiTooltipDescribesHost', transform: booleanAttribute });
    ...
    text = computed(() => (Array.isArray(this.content()) ? '' : this.content()), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "text" }] : /* istanbul ignore next */ []));
    items = computed(() => (Array.isArray(this.content()) ? this.content() : []), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "items" }] : /* istanbul ignore next */ []));
    // An empty array is truthy, so emptiness has to be asked of the normalised forms rather than of the input.
    isEmpty = computed(() => !this.text() && this.items().length === 0, /* @ts-ignore */
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTooltipDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.1.6", type: TumUiTooltipDirective, isStandalone: true, selector: "[tumUiTooltip]", inputs: { content: { classPropertyName: "content", publicName: "tumUiTooltip", isSignal: true, isRequired: true, transformFunction: null }, placement: { classPropertyName: "placement", publicName: "tumUiTooltipPlacement", isSignal: true, isRequired: false, transformFunction: null }, describesHost: { classPropertyName: "describesHost", publicName: "tumUiTooltipDescribesHost", isSignal: true, isRequired: false, transformFunction: null }, showDelayMs: { classPropertyName: "showDelayMs", publicName: "showDelayMs", isSignal: true, isRequired: false, transformFunction: null }, hideDelayMs: { classPropertyName: "hideDelayMs", publicName: "hideDelayMs", isSignal: true, isRequired: false, transformFunction: null } }, host: { listeners: { "mouseenter": "onHoverStart()", "mouseleave": "onHoverEnd()", "mousedown": "onPointerDown()", "focusin": "onFocusStart()", "focusout": "onFocusEnd()", "keydown.escape": "hideNow()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTooltipDirective, decorators: [{
            type: Directive,
            args: [{
        ...
        }], ctorParameters: () => [], propDecorators: { content: [{ type: i0.Input, args: [{ isSignal: true, alias: "tumUiTooltip", required: true }] }], placement: [{ type: i0.Input, args: [{ isSignal: true, alias: "tumUiTooltipPlacement", required: false }] }], describesHost: [{ type: i0.Input, args: [{ isSignal: true, alias: "tumUiTooltipDescribesHost", required: false }] }], showDelayMs: [{ type: i0.Input, args: [{ isSignal: true, alias: "showDelayMs", required: false }] }], hideDelayMs: [{ type: i0.Input, args: [{ isSignal: true, alias: "hideDelayMs", required: false }] }] } });
...
class TumUiInputGroupAddonComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiInputGroupAddonComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.1.6", type: TumUiInputGroupAddonComponent, isStandalone: true, selector: "tum-ui-input-group-addon", host: { classAttribute: "tum-ui-input-group-addon tum:bg-control-background tum:text-muted tum:border-y tum:first:border-s tum:first:rounded-s-md tum:last:border-e tum:last:rounded-e-md" }, ngImport: i0, template: '<ng-content />', isInline: true, styles: [":host{display:flex;align-items:center;justify-content:center;padding:calc(var(--tumaet-ui-spacing) * 2);min-width:calc(var(--tumaet-ui-spacing) * 10);white-space:nowrap;border-color:var(--tum-ui-input-group-border-color, var(--tumaet-ui-control-border-color));transition:border-color .2s}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiInputGroupAddonComponent, decorators: [{
            type: Component,
...
class TumUiInputDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiInputDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.1.6", type: TumUiInputDirective, isStandalone: true, selector: "input[tumUiInput], textarea[tumUiInput], textarea[tumUiTextarea]", inputs: { tumUiInputSize: { classPropertyName: "tumUiInputSize", publicName: "tumUiInputSize", isSignal: true, isRequired: false, transformFunction: null }, tumUiInputInvalid: { classPropertyName: "tumUiInputInvalid", publicName: "tumUiInputInvalid", isSignal: true, isRequired: false, transformFunction: null }, tumUiInputId: { classPropertyName: "tumUiInputId", publicName: "tumUiInputId", isSignal: true, isRequired: false, transformFunction: null }, tumUiInputDescribedBy: { classPropertyName: "tumUiInputDescribedBy", publicName: "tumUiInputDescribedBy", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "hostClasses()", "attr.id": "controlId()", "attr.aria-describedby": "describedBy()", "attr.aria-invalid": "isInvalid() || null" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiInputDirective, decorators: [{
            type: Directive,
            args: [{
...
class TumUiListItemActionDirective {
    ...
    ...(ngDevMode ? [{ debugName: "hostClasses" }] : /* istanbul ignore next */ []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiListItemActionDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.1.6", type: TumUiListItemActionDirective, isStandalone: true, selector: "a[tumUiListItemAction], button[tumUiListItemAction]", inputs: { active: { classPropertyName: "active", publicName: "active", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "hostClasses()", "attr.aria-current": "active() ? \"page\" : null" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiListItemActionDirective, decorators: [{
            type: Directive,
            args: [{
...
class TumUiListItemDirective {
    ...
    ...(ngDevMode ? [{ debugName: "hostClasses" }] : /* istanbul ignore next */ []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiListItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.2.0", version: "22.1.6", type: TumUiListItemDirective, isStandalone: true, selector: "li[tumUiListItem]", inputs: { inline: { classPropertyName: "inline", publicName: "inline", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "hostClasses()" } }, queries: [{ propertyName: "action", first: true, predicate: TumUiListItemActionDirective, descendants: true, isSignal: true }], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiListItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class TumUiListComponent {
    ...
    ariaLabelledBy = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "ariaLabelledBy" }] : /* istanbul ignore next */ []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiListComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.1.6", type: TumUiListComponent, isStandalone: true, selector: "tum-ui-list", inputs: { ariaLabel: { classPropertyName: "ariaLabel", publicName: "ariaLabel", isSignal: true, isRequired: false, transformFunction: null }, ariaLabelledBy: { classPropertyName: "ariaLabelledBy", publicName: "ariaLabelledBy", isSignal: true, isRequired: false, transformFunction: null } }, host: { classAttribute: "tum-ui-list" }, ngImport: i0, template: "<ul role=\"list\" class=\"tum-ui-list-items tum:m-0 tum:flex tum:list-none tum:flex-col tum:p-0\" [attr.aria-label]=\"ariaLabel()\" [attr.aria-labelledby]=\"ariaLabelledBy()\">\n    <ng-content />\n</ul>\n", styles: [":host{display:block}.tum-ui-list-items{border:1px solid var(--tumaet-ui-border-color);border-radius:var(--tumaet-ui-radius-md);overflow:hidden}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiListComponent, decorators: [{
            type: Component,
...
class TumUiMenuItemDirective {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiMenuItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "22.1.6", type: TumUiMenuItemDirective, isStandalone: true, selector: "[tumUiMenuItem]", host: { classAttribute: "tum-ui-menu-item tum:flex tum:cursor-pointer tum:items-center tum:gap-2 tum:border-0 tum:bg-transparent tum:px-3 tum:py-2 tum:text-start tum:text-base tum:text-text tum:no-underline tum:hover:bg-hover-background tum:hover:text-text-hover tum:focus-visible:bg-highlight-focus-background tum:focus-visible:text-highlight tum:focus-visible:outline-none tum:aria-disabled:pointer-events-none tum:aria-disabled:cursor-default tum:aria-disabled:text-disabled" }, hostDirectives: [{ directive: i1$1.CdkMenuItem, inputs: ["cdkMenuItemDisabled", "disabled"], outputs: ["cdkMenuItemTriggered", "triggered"] }], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiMenuItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class TumUiMenuTriggerDirective {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiMenuTriggerDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "22.1.6", type: TumUiMenuTriggerDirective, isStandalone: true, selector: "[tumUiMenuTrigger]", hostDirectives: [{ directive: i1$1.CdkMenuTrigger, inputs: ["cdkMenuTriggerFor", "tumUiMenuTrigger", "cdkMenuPosition", "tumUiMenuPosition"], outputs: ["cdkMenuOpened", "menuOpened", "cdkMenuClosed", "menuClosed"] }], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiMenuTriggerDirective, decorators: [{
            type: Directive,
            args: [{
...
class TumUiMessageComponent {
    ...
    icon = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "icon" }] : /* istanbul ignore next */ []));
    messageRole = computed(() => (this.severity() === 'error' ? 'alert' : 'status'), /* @ts-ignore */
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiMessageComponent, decorators: [{
        ...
        }], propDecorators: { severity: [{ type: i0.Input, args: [{ isSignal: true, alias: "severity", required: false }] }], text: [{ type: i0.Input, args: [{ isSignal: true, alias: "text", required: false }] }], icon: [{ type: i0.Input, args: [{ isSignal: true, alias: "icon", required: false }] }] } });
...
class TumUiPopoverTriggerDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiPopoverTriggerDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.1.6", type: TumUiPopoverTriggerDirective, isStandalone: true, selector: "[tumUiPopoverTrigger]", inputs: { popover: { classPropertyName: "popover", publicName: "tumUiPopoverTrigger", isSignal: true, isRequired: true, transformFunction: null } }, host: { listeners: { "click": "toggle()" }, properties: { "attr.aria-haspopup": "'dialog'", "attr.aria-expanded": "popover().isOpen() ? 'true' : 'false'" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiPopoverTriggerDirective, decorators: [{
            type: Directive,
            args: [{
...
class TumUiPopoverComponent {
     ...
     */
    appliedPlacement = signal('bottom', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "appliedPlacement" }] : /* istanbul ignore next */ []));
    ...
    fadeOutAndDispose(closing) {
        ...
        animation.finished.then(() => closing.dispose(), () => closing.dispose());
    }
...
class TumUiTabsService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabsService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabsService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabsService, decorators: [{
            type: Injectable
        }] });
...
class TumUiTabPanelComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabPanelComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.1.6", type: TumUiTabPanelComponent, isStandalone: true, selector: "tum-ui-tab-panel", inputs: { value: { classPropertyName: "value", publicName: "value", isSignal: true, isRequired: true, transformFunction: null } }, host: { attributes: { "role": "tabpanel" }, properties: { "id": "id()", "attr.aria-labelledby": "tabId()", "attr.tabindex": "active() ? 0 : undefined", "hidden": "!active()" }, classAttribute: "tum-ui-tab-panel tum:focus-visible:outline tum:focus-visible:outline-2 tum:focus-visible:outline-focus" }, ngImport: i0, template: '@if (active()) { <ng-content /> }', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabPanelComponent, decorators: [{
            type: Component,
            args: [{
...
class TumUiTabPanelsComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabPanelsComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.1.6", type: TumUiTabPanelsComponent, isStandalone: true, selector: "tum-ui-tab-panels", host: { classAttribute: "tum-ui-tab-panels" }, ngImport: i0, template: '<ng-content />', isInline: true, styles: [":host{display:block;padding:calc(var(--tumaet-ui-spacing) * 3.5) calc(var(--tumaet-ui-spacing) * 4.5) calc(var(--tumaet-ui-spacing) * 4.5)}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabPanelsComponent, decorators: [{
            type: Component,
            args: [{ selector: 'tum-ui-tab-panels', template: '<ng-content />', host: {
                        class: 'tum-ui-tab-panels',
                    }, changeDetection: ChangeDetectionStrategy.OnPush, styles: [":host{display:block;padding:calc(var(--tumaet-ui-spacing) * 3.5) calc(var(--tumaet-ui-spacing) * 4.5) calc(var(--tumaet-ui-spacing) * 4.5)}\n"] }]
        }] });
...
class TumUiTabsComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabsComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.1.6", type: TumUiTabsComponent, isStandalone: true, selector: "tum-ui-tabs", inputs: { value: { classPropertyName: "value", publicName: "value", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { value: "valueChange" }, host: { classAttribute: "tum-ui-tabs tum:flex tum:w-full tum:min-w-0 tum:max-w-full tum:flex-col" }, providers: [TumUiTabsService], ngImport: i0, template: '<ng-content />', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.6", ngImport: i0, type: TumUiTabsComponent, decorators: [{
            type: Component,
            args: [{
