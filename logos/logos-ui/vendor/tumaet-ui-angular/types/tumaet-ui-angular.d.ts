...
declare class TumUiMessageComponent {
    ...
    readonly icon: _angular_core.InputSignal<IconProp | undefined>;
    protected readonly messageRole: _angular_core.Signal<"alert" | "status">;
    protected readonly hostClasses: _angular_core.Signal<string>;
    static ɵfac: _angular_core.ɵɵFactoryDeclaration<TumUiMessageComponent, never>;
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<TumUiMessageComponent, "tum-ui-message", never, { "severity": { "alias": "severity"; "required": false; "isSignal": true; }; "text": { "alias": "text"; "required": false; "isSignal": true; }; "icon": { "alias": "icon"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, never>;
}
...
declare class TumUiPopoverComponent implements OnDestroy {
     ...
     */
    protected readonly appliedPlacement: _angular_core.WritableSignal<TumUiOverlayPlacement>;
...
declare class TumUiTabPanelComponent {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<TumUiTabPanelComponent, "tum-ui-tab-panel", never, { "value": { "alias": "value"; "required": true; "isSignal": true; }; }, {}, never, ["*"], true, never>;
}
...
declare class TumUiTabPanelsComponent {
    ...
    static ɵcmp: _angular_core.ɵɵComponentDeclaration<TumUiTabPanelsComponent, "tum-ui-tab-panels", never, {}, {}, never, ["*"], true, never>;
}
...
declare class TumUiTooltipDirective implements OnDestroy {
    ...
    readonly content: _angular_core.InputSignal<string | readonly string[]>;
    readonly placement: _angular_core.InputSignal<TumUiOverlayPlacement>;
    /**
     ...
     */
    readonly describesHost: _angular_core.InputSignalWithTransform<boolean, unknown>;
