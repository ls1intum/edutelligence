...
export default function Privacy() {
  return (
      <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center', paddingVertical: 40, paddingHorizontal: 20 }}>
        <Box className="w-full max-w-[1440px]">
            <Text size="3xl" className="font-bold mb-6 text-left text-black dark:text-white">
              Privacy Policy
            </Text>
            ...
            <VStack space="lg">
                ...
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Logging</Text>
                    ...
                    <VStack space="xs" className="pl-4 mb-2">
                        <Text className="text-black dark:text-white">• IP address of the requesting computer</Text>
                        <Text className="text-black dark:text-white">• Date and time of access</Text>
                        <Text className="text-black dark:text-white">• Name, URL and transferred data volume of the accessed file</Text>
                        <Text className="text-black dark:text-white">• Access status (requested file transferred, not found etc.)</Text>
                        <Text className="text-black dark:text-white">• Identification data of the browser and operating system used (if transmitted by the requesting web browser)</Text>
                        <Text className="text-black dark:text-white">• Website from which access was made (if transmitted by the requesting web browser)</Text>
                    </VStack>
                    <Text className="text-black dark:text-white mb-2">
                        The processing of the data in this log file takes place as follows:
                    </Text>
                    <VStack space="xs" className="pl-4 mb-2">
                        <Text className="text-black dark:text-white">• The log entries are continuously updated automatically evaluated in order to be able to detect attacks on the web server and react accordingly.</Text>
                        <Text className="text-black dark:text-white">• In individual cases, i.e. in the case of reported disruptions, errors and security incidents, a manual analysis is carried out.</Text>
                        <Text className="text-black dark:text-white">• The IP addresses contained in the log entries are not merged with other databases by AET, so that no conclusions can be drawn about individual persons.</Text>
                    </VStack>
                </Box>

                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Use and transfer of personal data</Text>
                    <Text className="text-black dark:text-white">
                ...
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Revocation of your consent to data processing</Text>
                    <Text className="text-black dark:text-white">
                ...
                {/* ... Skipping middle sections for brevity but implementing Key Rights ... */}
                 ...
                 <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Right to file a complaint with the responsible supervisory authority</Text>
                    <Text className="text-black dark:text-white">
                        ...
                        link provides a list of data protection authorities and their contact details: <Text className="font-bold underline text-blue-500">https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html</Text>.
                    </Text>
                </Box>

                 <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">SSL/TLS encryption</Text>
                    <Text className="text-black dark:text-white">
                 ...
                 <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">E-mail security</Text>
                    <Text className="text-black dark:text-white">
