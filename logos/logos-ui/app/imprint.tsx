  ...
  return (
      <ScrollView contentContainerStyle={{ flexGrow: 1, alignItems: 'center', paddingVertical: 40, paddingHorizontal: 20 }}>
        <Box className="w-full max-w-[1440px]">
            ...
            <VStack space="lg">
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Publisher</Text>
                ...
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Authorized to represent</Text>
                    <Text className="text-black dark:text-white">
                ...
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">VAT identification number</Text>
                    <Text className="text-black dark:text-white">
                ...
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Responsible for content</Text>
                    <Text className="text-black dark:text-white">
                ...
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Terms of use</Text>
                    ...
                    <Text className="text-black dark:text-white">
                        ...
                        the existence of possible third-party rights.
                    </Text>
                </Box>

                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Liability disclaimer</Text>
                    <Text className="text-black dark:text-white mb-2">
                    ...
                    <Text className="text-black dark:text-white mb-2">
                        ...
                        the installation or use of software from this website.
                    </Text>
                    <Text className="text-black dark:text-white">
                ...
                <Box>
                    <Text size="md" className="font-bold mb-2 text-black dark:text-white">Links</Text>
                    <Text className="text-black dark:text-white">
                        Our own content is to be distinguished from cross-references (“links”) to websites of other providers. These links
