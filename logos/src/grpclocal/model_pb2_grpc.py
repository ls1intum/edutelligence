...
if _version_not_supported:
    raise RuntimeError(
        f'The grpclocal package installed is at version {GRPC_VERSION},'
        + f' but the generated code in model_pb2_grpc.py depends on'
        + f' grpcio>={GRPC_GENERATED_VERSION}.'
        + f' Please upgrade your grpclocal module to grpcio>={GRPC_GENERATED_VERSION}'
...
class ModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        Args:
            channel: A grpclocal.Channel.
        """
        self.Generate = channel.unary_stream(
                '/src.grpclocal.ModelService/Generate',
...
def add_ModelServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'src.grpclocal.ModelService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('src.grpclocal.ModelService', rpc_method_handlers)
