...
Multi-provider: tries all deployments for the top candidate before queueing.
"""
...
class FcfScheduler(BaseScheduler):
    ...
    Multi-provider: tries every deployment for the top-ranked model.
    """
    ...
    async def schedule(self, request: SchedulingRequest) -> Optional[SchedulingResult]:
        ...
        # Try immediate selection on each deployment
        ...
        if logosnode_dep is None:
            return None  # All cloud, none accepted
