...
| `course-dashboard-low`               | `chat`             | `COURSE_CHAT`               | `low`      | `foundation` | Dashboard interpretation with low support            |
...
| `course-soft-due-moderate`           | `chat`             | `COURSE_CHAT`               | `moderate` | `foundation` | Competency approaching its soft due date             |
