def tutor_suggestion_final_rules():
    return """
Rules:
1. Only use information from the problem statement and code feedback. Do not invent or add content from outside these sources.
...
4. Otherwise, return 1–3 short suggestions in this exact HTML format, in one line: {{"result": "<ul><li>suggestion1</li><li>suggestion2</li></ul>"}}.
