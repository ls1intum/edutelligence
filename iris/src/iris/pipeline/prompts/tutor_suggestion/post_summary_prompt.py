...
5. If a question is answered in the thread, you must include the question as a question and the answer in the summary. 
The question must be explicitly stated in the summary, and the answer must be explicitly stated in the summary. If the 
post is the question, state that it is asked and then add the answer if there is one. If the question is answered by 
multiple answers, you must include all the answers in the summary.
