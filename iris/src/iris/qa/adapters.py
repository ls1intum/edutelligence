...
class ScenarioAdapters:
    ...
    def __enter__(self):
        ...
        patches = {
            (
                "iris.pipeline.abstract_agent_pipeline.VectorDatabase"
            ): FixtureVectorDatabase,
            ("iris.pipeline.abstract_agent_pipeline.MemirisWrapper"): FixtureMemiris,
            (
                "iris.pipeline.chat.chat_pipeline.LectureRetrieval"
            ): FixtureLectureRetrieval,
            (
                "iris.tools.chat_tool_providers.LectureRetrieval"
            ): FixtureLectureRetrieval,
            "iris.tools.chat_tool_providers.FaqRetrieval": FixtureFaqRetrieval,
            (
                "iris.pipeline.tutor_suggestion_pipeline.LectureRetrieval"
            ): FixtureLectureRetrieval,
            "iris.pipeline.tutor_suggestion_pipeline.FaqRetrieval": FixtureFaqRetrieval,
            (
                "iris.pipeline.autonomous_tutor_pipeline.LectureRetrieval"
            ): FixtureLectureRetrieval,
            "iris.pipeline.autonomous_tutor_pipeline.FaqRetrieval": FixtureFaqRetrieval,
            (
                "iris.pipeline.global_search_pipeline.LectureGlobalSearchRetrieval"
            ): FixtureGlobalRetriever,
            "iris.pipeline.chat.chat_pipeline.datetime": FrozenDateTime,
            (
                "iris.pipeline.tutor_suggestion_pipeline."
                "get_current_utc_datetime_string"
            ): current_time_string,
            (
                "iris.pipeline.autonomous_tutor_pipeline."
                "get_current_utc_datetime_string"
            ): current_time_string,
