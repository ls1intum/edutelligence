...
from . import faq_pb2 as faq__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in faq_pb2_grpc.py depends on'
...
class FAQServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FAQServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessInput': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessInput,
                    request_deserializer=faq__pb2.FaqRewritingRequest.FromString,
                    response_serializer=faq__pb2.FaqRewritingResponse.SerializeToString,
            ),
    }
