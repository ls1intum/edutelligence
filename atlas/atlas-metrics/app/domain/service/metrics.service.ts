...
export interface IMetricsService {
     ...
     */
    registerEndpointActivity(service: string, version: string, endpoint: string, type: RequestType): Promise<void>;
...
export class MetricsServiceImpl implements IMetricsService {
    ...
    async registerEndpointActivity(service: string, version: string, endpoint: string, type: RequestType): Promise<void> {
    ...
    async getEndpointActivity(service?: string, version?: string, endpoint?: string, type?: RequestType, from?: Date, to?: Date): Promise<EndpointActivityFullDAO[]> {
        return await this.metricsRepository.getEndpointActivity(service, version, endpoint, type, from, to);
    }
