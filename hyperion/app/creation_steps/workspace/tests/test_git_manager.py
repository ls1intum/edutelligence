...
from app.creation_steps.step3_create_solution_repository.models import SolutionCreationContext
...
class TestGitManager:
    ...
    def git_manager(self):
        ...
        with patch.object(GitManager, '_find_git_executable', return_value='/usr/bin/git'):
            return GitManager()
    ...
    def test_initialize_repository_success(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_initialize_repository_already_exists(self, git_manager, mock_context, mock_subprocess_run):
        ...
        assert not any(call[0][0][1] == 'init' for call in mock_subprocess_run.call_args_list)

    def test_initialize_repository_git_init_fails(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_add_files_no_valid_patterns(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_commit_changes_success(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_commit_changes_nothing_to_commit(self, git_manager, mock_context, mock_subprocess_run):
        """Test commit when nothing to commit."""
        mock_subprocess_run.return_value.returncode = 1
        mock_subprocess_run.return_value.stdout = "nothing to commit, working tree clean"
    ...
    def test_create_branch_success(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_create_branch_already_exists(self, git_manager, mock_context, mock_subprocess_run):
        ...
        assert not any('checkout' in str(call) for call in mock_subprocess_run.call_args_list)
    ...
    def test_get_commit_history_success(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_get_commit_history_no_commits(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_create_tag_lightweight(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_create_tag_already_exists(self, git_manager, mock_context, mock_subprocess_run):
        ...
        assert not any('tag' in str(call) for call in mock_subprocess_run.call_args_list)
    ...
    def test_run_git_command_success(self, git_manager, mock_context, mock_subprocess_run):
    ...
    def test_validate_branch_name_invalid(self, git_manager):
        ...
        invalid_names = ["", "branch@name", "branch#name", "-invalid", "invalid.", "branch..name"]
    ...
    def test_validate_tag_name_invalid(self, git_manager):
        ...
        invalid_names = ["", "tag@name", "tag#name", "-invalid", "invalid.", "tag..name"]
