...
class QualityDriftAnalysisRunner:
    ...
    async def check_and_generate_baseline(self) -> bool:
        ...
        try:
            ...
            # Process each submission and generate baseline feedbacks
            updated_submissions = []
            ...
            for submission_data in exercise_data["submissions"]:
                ...
                # Create updated submission with baseline feedbacks
                updated_submission = {
                    "id": submission_data["id"],
                    "text": submission_data["text"],
                    "meta": submission_data.get("meta", {}),
                    "feedbacks": baseline_feedbacks
                }
    ...
    async def run_quality_drift_analysis(self) -> Dict[str, Any]:
        ...
        # Test with 3 random submissions (or all if fewer than 3)
    ...
    def generate_comprehensive_report(self, analysis_results: Dict[str, Any]) -> None:
        """Generate a simple analysis report with average metrics."""
        ...
        # Create simple report with just averages
        simple_report = {
        ...
        # Add average metrics for each model
        for model_name, results in model_comparison.items():
            simple_report["model_results"][model_name] = {
    ...
    def print_analysis_summary(self, analysis_results: Dict[str, Any]) -> None:
        ...
        for model_name, results in model_comparison.items():
            ...
            print(f"  {model_name}: BERTScore F1={f1_score:.3f}, Credit Drift={credit_drift:.2f}")
...
async def main():
    ...
    runner = QualityDriftAnalysisRunner()
