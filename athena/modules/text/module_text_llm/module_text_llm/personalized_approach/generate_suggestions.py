...
async def generate_suggestions(exercise: Exercise, submission: Submission, config: ApproachConfig, debug: bool,
    ...
    if learner_profile is None:
        learner_profile = LearnerProfile(
            practical_theoretical=1.0,  # Balanced between practical and theoretical
            creative_guidance=1.0,      # Balanced between creative exploration and focused guidance
            followup_summary=1.0,       # Balanced between follow-up questions and summary
            brief_detailed=1.0          # Balanced between brief and detailed
        )
